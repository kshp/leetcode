...
public class SubstringWithConcatenationOfAllWords_30Test {
    ...
    public void getCombination() {
        List<Integer> actualResult = SubstringWithConcatenationOfAllWords_30.findSubstring(s1, words1);
        assertThat(actualResult, is(equalTo(result1)));

        actualResult = SubstringWithConcatenationOfAllWords_30.findSubstring(s2, words2);
        assertThat(actualResult, is(equalTo(result2)));

        actualResult = SubstringWithConcatenationOfAllWords_30.findSubstring(s3, words3);
        assertThat(actualResult, is(equalTo(result3)));

        actualResult = SubstringWithConcatenationOfAllWords_30.findSubstring(s4, words4);
        assertThat(actualResult, is(equalTo(result4)));

        actualResult = SubstringWithConcatenationOfAllWords_30.findSubstring(s5, words5);
        assertThat(actualResult, is(equalTo(result5)));

        actualResult = SubstringWithConcatenationOfAllWords_30.findSubstring(s6, words6);
        assertThat(actualResult, is(equalTo(result6)));

        actualResult = SubstringWithConcatenationOfAllWords_30.findSubstring(s7, words7);
