...
public class MedianOfTwoSortedArrays_4Test {
    ...
    public void findMedianSortedArrays() {
        assertThat(MedianOfTwoSortedArrays_4.findMedianSortedArrays(nums1_1, nums2_1), is(equalTo(result1)));
        assertThat(MedianOfTwoSortedArrays_4.findMedianSortedArrays(nums1_2, nums2_2), is(equalTo(result2)));
        assertThat(MedianOfTwoSortedArrays_4.findMedianSortedArrays(nums1_3, nums2_3), is(equalTo(result3)));
        assertThat(MedianOfTwoSortedArrays_4.findMedianSortedArrays(nums1_4, nums2_4), is(equalTo(result4)));
        assertThat(MedianOfTwoSortedArrays_4.findMedianSortedArrays(nums1_5, nums2_5), is(equalTo(result5)));
        assertThat(MedianOfTwoSortedArrays_4.findMedianSortedArrays(nums1_6, nums2_6), is(equalTo(result6)));
        assertThat(MedianOfTwoSortedArrays_4.findMedianSortedArrays(nums1_7, nums2_7), is(equalTo(result7)));
    }
}