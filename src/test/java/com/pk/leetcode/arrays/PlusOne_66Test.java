...
public class PlusOne_66Test {
    ...
    @Test
    public void plusOne() {
        assertThat(compareArrays(PlusOne_66.plusOne(arr1), resultArr1), is(true));
        assertThat(compareArrays(PlusOne_66.plusOne(arr2), resultArr2), is(true));
        assertThat(compareArrays(PlusOne_66.plusOne(arr3), resultArr3), is(true));
        assertThat(compareArrays(PlusOne_66.plusOne(arr4), resultArr4), is(true));
        assertThat(compareArrays(PlusOne_66.plusOne(arr5), resultArr5), is(true));
    }
